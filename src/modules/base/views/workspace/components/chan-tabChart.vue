<template>
	<div class="tab-chart">
		...
		<div class="tab-chart__container">
			<div id="ChanChart" class="echarts" :option="chart" />
		</div>
	</div>
</template>
...
var barWidth = 40;
onMounted(() => {
	const chartDom = document.getElementById("ChanChart")!;
...
<style>
.tab-chart__filter[data-v-3649b3a3] .el-date-editor {
	width: 100%;
	cursor: pointer;
}
</style>
